...
include("../Cartpole/cartpole_sysid_reg_test.jl")
...
for seed in 1:50
    ...
    b_end_seed, mp_estimates_seed, mp_variances_seed, ΣΘΘ_seed, all_s_seed = regression(seed)
    ...
    all_s[seed] = all_s_seed

    # Save all dictionaries to a JLD2 file
    @save "reg_cartpolefull_miac_results.jld2" all_b_ends all_mp_estimates all_mp_variances all_ΣΘΘ all_s
end
