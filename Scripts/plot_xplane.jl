...
log_probs = [log_multivariate_normal_pdf(all_ABtrue[plotting_seed ], all_AB_estimates[plotting_seed ][i], all_AB_variances[plotting_seed][i]) for i in 1:t]
time_steps = collect(1:t)
plot(time_steps, log_probs_bilqr, label="EKF")
